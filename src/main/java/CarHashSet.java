...
public class CarHashSet implements CarSet {
    ...
    public boolean remove(Car car) {
        ...
        Entry secondLast = array[position]; //предпоследний элемент
        Entry last = secondLast.next; // последний элемент
    ...
    private int getElementPosition(Car car, int sizeArray) {
        return Math.abs(car.hashCode() % sizeArray); // возвращает позицию определенного элемента
    }
